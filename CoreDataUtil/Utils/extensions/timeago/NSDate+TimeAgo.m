...
- (NSString *)timeAgoSimple
{
    ...
    if (deltaSeconds <= 0) {
        return [self timeAgoPast:fabs(deltaSeconds) andMinutes:fabs(deltaMinutes)];
    } else {
        // Uses abosoute value to keep timeAgoPast and timeAgoFuture as similar as possible
        return [self timeAgoSimpleFuture:deltaSeconds andMinutes:deltaMinutes];
    }
}

- (NSString *)timeAgoSimpleFuture:(double) deltaSeconds andMinutes:(double) deltaMinutes {
    int value;
...
- (NSString *)timeAgoSimplePast:(double) deltaSeconds andMinutes:(double) deltaMinutes {
    int value;
...
- (NSString *)timeAgo
{
    ...
    if (deltaMinutes <= 0) {
        ...
        return [self timeAgoFuture:deltaSeconds andMinutes:deltaMinutes];
    }
}

- (NSString*) timeAgoFuture:(double) deltaSeconds andMinutes:(double) deltaMinutes {
    ...
    {
        return [self stringFromFormat:@"In %%d %@seconds" withValue:deltaSeconds];
    }
    else if(deltaSeconds < 120)
    {
        return NSDateTimeAgoLocalizedStrings(@"In about a minute");
    }
    else if (deltaMinutes < 60)
    {
        return [self stringFromFormat:@"In about %%d %@minutes" withValue:deltaMinutes];
    }
    ...
    else if (deltaMinutes < (24 * 60))
    {
        ...
        return [self stringFromFormat:@"In %%d %@hours" withValue:minutes];
    }
    ...
    else if (deltaMinutes < (24 * 60 * 7))
    {
        ...
        return [self stringFromFormat:@"In %%d %@days" withValue:minutes];
    }
    ...
    else if (deltaMinutes < (24 * 60 * 31))
    {
        ...
        return [self stringFromFormat:@"In %%d %@weeks" withValue:minutes];
    }
    ...
    else if (deltaMinutes < (24 * 60 * 365.25))
    {
        ...
        return [self stringFromFormat:@"In %%d %@months" withValue:minutes];
    }
    ...
    return [self stringFromFormat:@"In %%d %@years" withValue:minutes];
}

- (NSString*) timeAgoPast:(double) deltaSeconds andMinutes:(double) deltaMinutes {
